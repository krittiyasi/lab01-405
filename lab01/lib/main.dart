...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 98, 242, 15)),
        useMaterial3: true,
      ),
      home: MyAppPage(),
    );
...
class MyAppPage extends StatelessWidget {
  ...
  Widget displayNameItem({required String name, required String imagePath}) {
    bool isHighlight = name == "กฤติยา สินโพธิ์ 643450320-4";

    return Container(
      padding: const EdgeInsets.all(10),
      color: isHighlight ? Color.fromARGB(255, 174, 27, 242) : Colors.transparent,
      child: Row(
        children: [
          Image(
            width: 100,
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isHighlight ? Color.fromARGB(255, 255, 255, 255) : Colors.black,
            ),
          ),
        ],
      ),
